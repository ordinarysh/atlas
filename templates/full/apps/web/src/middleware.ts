 ...
 *
 * To enable: Set ENABLE_SECURITY_MIDDLEWARE=true in your environment variables
 *
...
export function middleware(request: NextRequest) {
  // Feature flag guard - disabled by default for development flexibility
  ...
  // Add CORS headers for API routes with environment-based origins
  const allowedOrigins = process.env.ALLOWED_ORIGINS ?? '*'
